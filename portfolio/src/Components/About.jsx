...
const About = () => {
    ...
    return (
        <div className='border-b lg:border-neutral-900 border-neutral-800 pb-4 lg:mb-16' id='about'>
            <motion.h1 initial={{ y: -50, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ duration: 0.5 }} className='lg:mt-8 mt-12 mb-12 lg:mb-8 text-center text-4xl font-thin text-neutral-400'>About <span className='text-neutral-500 font-thin'>Me</span></motion.h1>
            <div className='flex flex-wrap'>
                ...
                <div className='w-full lg:w-1/2'>
                    <div className='flex flex-col justify-center lg:justify-start'>
                        {aboutPara.map((paragraph, index) => (
                            <motion.p
                                ...
                                className={`my-2 max-w-xl ${index === 0 ? 'pt-6' : 'pb-6'}`}>
                                {paragraph}
                            </motion.p>
                        ))}
                    </div>
                    <div className="flex flex-col gap-4">
                        <motion.div whileInView={{ opacity: 1, x: 0 }} initial={{ x: 100, opacity: 0 }} transition={{ duration: 1.2 }} className="flex gap-5 items-center">
                            <p className='w-40 shrink-0'>Leadership</p>
                        ...
                        <motion.div whileInView={{ opacity: 1, x: 0 }} initial={{ x: 100, opacity: 0 }} transition={{ duration: 1.4 }} className="flex gap-5 items-center">
                            <p className='w-40 shrink-0'>Analytical Thinking</p>
                        ...
                        <motion.div whileInView={{ opacity: 1, x: 0 }} initial={{ x: 100, opacity: 0 }} transition={{ duration: 1.6 }} className="flex gap-5 items-center">
                            <p className='w-40 shrink-0'>Problem Solving</p>
                ...
                <div className="flex w-full justify-around pt-12">
                    <motion.div initial={{ y: -30, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ duration: 1 }} className="flex flex-col items-center gap-3">
                        <h1 className='text-3xl bg-gradient-to-r from-amber-200 to-yellow-400 bg-clip-text text-transparent'>7+</h1>
                        <p className='text-xs lg:text-lg'>PROJECT COMPLETED</p>
                    </motion.div>
                    <hr />
                    <motion.div initial={{ y: -30, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ duration: 1 }} className="flex flex-col items-center gap-3">
                        <h1 className='text-3xl bg-gradient-to-r from-amber-200 to-yellow-400 bg-clip-text text-transparent'>15+</h1>
                        <p className='text-xs lg:text-lg'>ACHIVED SKILLS</p>
                    </motion.div>
                </div>
            </div>
        </div>
