...
const Technologies = () => {
    ...
    return (
        <div className='border-b lg:border-neutral-900 border-neutral-800 pb-20' id='skills'>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 lg:mx-60">
                    {skills && skills.map((element, index) => {
                        return (
                        <motion.div initial={{ x: -100, opacity: 0}} whileInView={{ x: 0, opacity: 1}} transition={{ duration: 1}}className="rounded-xl border-1 border-neutral-800 lg:p-1.5 p-1 shadow-lg shadow-[#000000]" key={element._id}>
